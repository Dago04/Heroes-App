        ...
        <>
            <div className="mx-auto flex justify-center flex-col gap-5 lg:flex-row">
                ...
                <div className="w-full lg:w-2/6 flex flex-col ">
                    ...
                    <div
                        className=" p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 animate__animated animate__fadeIn"
                        role=" alert"
                    ...
                    <div
                        className=" w-full  p-4 mb-3  text-sm text-red-800 rounded-lg bg-red-50 animate__animated animate__fadeIn"
                        role="alert"
